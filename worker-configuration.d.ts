/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: edd4e61b26f4c64605398e3fc487cf27)
// Runtime types generated with workerd@1.20260921.1 2026-09-21 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	PUBLIC_SUPABASE_URL: string;
	PUBLIC_SUPABASE_ANON_KEY: string;
	PUBLIC_SITE_URL: string;
	PUBLIC_OG_IMAGE: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_SUPABASE_URL" | "PUBLIC_SUPABASE_ANON_KEY" | "PUBLIC_SITE_URL" | "PUBLIC_OG_IMAGE" | "PUBLIC_CONTACT_EMAIL" | "PUBLIC_GITHUB_URL" | "PUBLIC_LINKEDIN_URL">> {}
}
